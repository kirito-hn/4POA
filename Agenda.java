...
public class Agenda {
	...
	private Agenda(String nome, String idade, String telefone) {
		super();
		this.nome = nome;
		this.idade = idade;
	...
	public void armazenaContato(String nome, String idade, String Altura) {
		...
		System.out.println("Digite onumero do telefone: ");
		setTelefone(telefone= scan.next());

		Agenda contato = new Agenda(getNome(), getIdade(), getTelefone());
		

		System.out.println(contato.nome + "; " + contato.idade + "; " + contato.telefone);
		if (agenda.size() < 2) {
			agenda.add(contato);
	...
	public void executar() {
		...
		do {
			...
			case 1:
				...
				do {
					armazenaContato(nome, idade, telefone);
					if(agenda.size()<=9) {
